...
const NOUNS = [
  // ''
  'crossing', 'reef', 'camp', 'village', 'alley', 'canyon', 'brook', 'passage', 'keep', 'tower', 'bridge', 'beach', 'bay', 'hollow', 'dream', 'planet', 'field', 'ruin', 'wall', 'garden', 'park', 'forest', 'depot', 'oasis', 'glade', 'hall', 'castle', 'fort', 'hill', 'lake', 'inlet', 'marsh', 'swamp', 'meadow', 'dock', 'mountain', 'peak', 'ocean', 'shoal', 'palace', 'barrens', 'pond', 'temple', 'way', 'island', 'river', 'farm', 'workshop', 'sea', 'villa', 'factory', 'waterfall', 'harbor', 'monolith', 'wood', 'outpost'
];
